...
const [app, css, header, familyTree, sectionTabs, downloads, blackWhale, worldMap, systemsDesk, search, drawer, packageJson] = await Promise.all([
  read('src/App.jsx'),
  read('src/styles.css'),
...
console.log('Accessibility audit passed: skip navigation; contained menus and dialogs; keyboard section and tree navigation; named scroll regions; live announcements; reduced motion and written status.');
