...
assert(header.includes("label: 'Succession Archive'") && header.includes("label: 'Nen Library'") && header.includes("label: 'World Atlas'"), 'the focused primary navigation is incomplete');
