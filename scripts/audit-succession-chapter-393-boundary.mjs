...
try {
  ...
  assert(numbers[numbers.indexOf(393) + 1] === 394 && numbers[numbers.indexOf(394) + 1] === 400, 'Chapter 393 must hand directly to Chapter 394 before the pre-existing Chapter 400 maintained packet');
