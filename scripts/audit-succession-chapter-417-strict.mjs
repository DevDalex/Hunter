...
assert(/latest published chapter at this integration boundary|publication ceiling/i.test(succession417SourcePolicy.publicationCeiling || ''),'417 must preserve its historical publication boundary without claiming to be the live global ceiling');
...
assert(/Unma/i.test(text) && /Halkenburg/i.test(text),'publication-boundary endpoint must be present');
...
console.log('Chapter 417 strict audit passed: 74 source-bounded events preserve the historical Chapter 417 publication boundary and Gypsy Life translation boundary.');
