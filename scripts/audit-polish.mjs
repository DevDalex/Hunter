...
const [safeImage, blackWhale, worldAtlas, worldMap, encyclopedia, familyTree, royalTree, royalTreeNodes, royalTreeModel, royalTreeBaseCss, royalTreeModuleCss, royalNetworks, archiveShell, archiveContrast, deepContrast, nenFixes, timeline, successionDossier, css, visualQa] = await Promise.all([
...
console.log('Polish audit passed: deterministic media; progressive rooms; clickable ship hotspots; concurrent timeline lanes; dense Royal Family dossier board with embedded protection circles, beasts, mafia links, and compact previews; complete Succession contrast ownership; repaired Nen card layout; contained uncropped imagery.');
