...
try {
  ...
  await runInteraction('desktop archive navigation focuses the new workspace', { width: 1440, height: 1000 }, 'succession/story', async (page) => {
    const timeline = page.locator('#succession-desktop-navigation a').filter({ hasText: 'Timeline' });
