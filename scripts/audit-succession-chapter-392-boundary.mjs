...
try {
  ...
  assert(numbers[numbers.indexOf(392) + 1] === 393 && numbers[numbers.indexOf(393) + 1] === 400, 'Chapter 392 must now hand directly to Chapter 393 before the pre-existing Chapter 400 maintained packet');
