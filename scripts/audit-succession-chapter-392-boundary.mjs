...
try {
  ...
  assert(numbers[numbers.indexOf(392) + 1] === 393 && numbers[numbers.indexOf(393) + 1] === 394 && numbers[numbers.indexOf(394) + 1] === 395 && numbers[numbers.indexOf(395) + 1] === 396 && numbers[numbers.indexOf(396) + 1] === 397 && numbers[numbers.indexOf(397) + 1] === 400, 'Chapter 392 must hand through Chapters 393, 394, 395, 396, and 397 before the pre-existing Chapter 400 maintained packet');
