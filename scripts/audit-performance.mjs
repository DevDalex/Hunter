...
assert(dynamicEntries.length === 18, `expected 18 route/search dynamic entries, found ${dynamicEntries.length}`);
...
assert((routePreload.match(/\(\) => import\(/g) || []).length === 18, 'the route loader registry must own 18 dynamic module boundaries');
