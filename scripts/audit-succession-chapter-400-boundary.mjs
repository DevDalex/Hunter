...
try {
  ...
  assert(index399 >= 0 && numbers[index399 + 1] === 400 && numbers[index399 + 2] === 406, 'maintained publication chain must place modernized Chapter 400 directly after 399 and before the pre-existing 406 packet');
