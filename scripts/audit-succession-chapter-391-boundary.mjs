...
try {
  ...
  assert(numbers[numbers.indexOf(391) + 1] === 392 && numbers[numbers.indexOf(392) + 1] === 393 && numbers[numbers.indexOf(393) + 1] === 394 && numbers[numbers.indexOf(394) + 1] === 400, 'Chapter 391 must lead through maintained Chapters 392, 393, and 394 before the pre-existing Chapter 400 packet');
