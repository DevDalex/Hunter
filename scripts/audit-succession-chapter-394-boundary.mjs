...
try {
  ...
  assert(numbers[numbers.indexOf(394) + 1] === 395 && numbers[numbers.indexOf(395) + 1] === 396 && numbers[numbers.indexOf(396) + 1] === 397 && numbers[numbers.indexOf(397) + 1] === 398 && numbers[numbers.indexOf(398) + 1] === 399 && numbers[numbers.indexOf(399) + 1] === 400, 'Chapter 394 must lead through maintained Chapters 395, 396, and 397 before the pre-existing Chapter 400 maintained packet');
