...
try {
  ...
  assert(numbers[numbers.indexOf(397) + 1] === 398 && numbers[numbers.indexOf(398) + 1] === 400, 'Chapter 397 must remain directly before the pre-existing Chapter 400 maintained packet');
