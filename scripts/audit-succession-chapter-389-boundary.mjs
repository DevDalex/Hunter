...
try {
  ...
  assert(numbers[numbers.indexOf(390) + 1] === 391 && numbers[numbers.indexOf(391) + 1] === 392 && numbers[numbers.indexOf(392) + 1] === 393 && numbers[numbers.indexOf(393) + 1] === 394 && numbers[numbers.indexOf(394) + 1] === 395 && numbers[numbers.indexOf(395) + 1] === 396 && numbers[numbers.indexOf(396) + 1] === 397 && numbers[numbers.indexOf(397) + 1] === 400, 'maintained ordering must preserve 390 → 391 → 392 → 393 → 394 → 395 → 396 → 397 before the pre-existing Chapter 400 packet');
