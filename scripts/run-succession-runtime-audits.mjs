...
const audits = Object.freeze([
  ...
  ['chapter-392-boundary', 'scripts/audit-succession-chapter-392-boundary.mjs'],
  ['chapter-393-boundary', 'scripts/audit-succession-chapter-393-boundary.mjs'],
  ['chapter-394-boundary', 'scripts/audit-succession-chapter-394-boundary.mjs'],
  ['chapter-394-people-closure', 'scripts/audit-succession-chapter-394-people-closure.mjs'],
  ['chapter-395-boundary', 'scripts/audit-succession-chapter-395-boundary.mjs'],
  ['chapter-396-boundary', 'scripts/audit-succession-chapter-396-boundary.mjs'],
  ...
  ['chapter-403-boundary', 'scripts/audit-succession-chapter-403-boundary.mjs'],
  ['chapter-404-boundary', 'scripts/audit-succession-chapter-404-boundary.mjs'],
  ['chapter-405-boundary', 'scripts/audit-succession-chapter-405-boundary.mjs'],
  ['chapter-406-boundary', 'scripts/audit-succession-chapter-406-boundary.mjs'],
  ['chapter-407-boundary', 'scripts/audit-succession-chapter-407-boundary.mjs'],
  ['chapter-408-boundary', 'scripts/audit-succession-chapter-408-boundary.mjs'],
  ['chapter-409-boundary', 'scripts/audit-succession-chapter-409-boundary.mjs'],
  ['chapter-410-boundary', 'scripts/audit-succession-chapter-410-boundary.mjs'],
  ['chapter-411-boundary', 'scripts/audit-succession-chapter-411-boundary.mjs'],
  ['chapter-412-boundary', 'scripts/audit-succession-chapter-412-boundary.mjs'],
