...
import SuccessionStoryComprehensionPanel from './SuccessionStoryComprehensionPanel';
...
export default function SuccessionNowDashboard({ chapter = 417, onNavigate }) {
  ...
  return <>
    <section className="succession-now" aria-labelledby="succession-now-title">
    ...
    <SuccessionStoryComprehensionPanel chapter={chapter} onNavigate={onNavigate} />
  </>;
}
