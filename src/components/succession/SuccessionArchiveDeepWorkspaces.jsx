...
export function QueensWorkspace({ routeParams = {}, spoilerLimit = latestChapter(), onNavigate }) {
  ...
  return <section className="succession-queen-board succession-queen-command" aria-labelledby="succession-queen-board-title">
    ...
    <dl className="succession-queen-status-strip"><div><dt style={{ color: 'black' }}>Queens</dt><dd>{records.length}</dd></div><div><dt style={{ color: 'black' }}>Active</dt><dd>{counts.active}</dd></div><div><dt style={{ color: 'black' }}>Exceptional</dt><dd>{counts.exceptional}</dd></div><div><dt style={{ color: 'black' }}>Deceased</dt><dd>{counts.deceased}</dd></div><div><dt style={{ color: 'black' }}>Linked princes</dt><dd>{counts.children}</dd></div></dl>
