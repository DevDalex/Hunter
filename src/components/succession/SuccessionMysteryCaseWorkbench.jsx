...
import SuccessionContentCompletionWorkbench from './SuccessionContentCompletionWorkbench';
import SuccessionContentDepthWorkbench from './SuccessionContentDepthWorkbench';
import SuccessionDeepArchiveWorkbench from './SuccessionDeepArchiveWorkbench';
...
export default function SuccessionMysteryCaseWorkbench({ routeParams = {}, spoilerLimit = 417, onNavigate }) {
  ...
  if (depthActive) {
    ...
    return <>
      <SuccessionContentCompletionWorkbench spoilerLimit={spoilerLimit} />
      <SuccessionDeepArchiveWorkbench routeParams={routeParams} spoilerLimit={spoilerLimit} onNavigate={depthNavigate} />
