...
function BlackWhaleModule({ onNavigate }) {
  return <ArchitecturePanel number="3" title="Black Whale" subtitle="The voyage and environments"><div className="succession-architecture__split-grid">
    <a href={routeToHref('succession', 'black-whale')} aria-label="Ship Atlas" data-route-action="Open ship atlas" onClick={(event) => navigateLink(event, onNavigate, 'black-whale')}><strong>Ship Atlas</strong><ShipBlueprint /><small>Decks, rooms, systems, facilities, and personnel zones.</small></a>
    <a href={routeToHref('succession', 'locations')} aria-label="Locations" data-route-action="Open location records" onClick={(event) => navigateLink(event, onNavigate, 'locations')}><strong>Locations</strong><MapSketch /><small>Destinations, sections, and notable areas.</small></a>
