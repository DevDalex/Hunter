  ...
  return <section className="arc-visual-archive" aria-labelledby={`${arcId}-visual-archive-title`}>
    ...
    <div className="arc-visual-workbench">
      <article className="arc-visual-stage" aria-live="polite">
        <figure><div className="arc-visual-stage__fallback" aria-hidden="true"><span>{String(selectedIndex + 1).padStart(2, '0')}</span><strong>{selected.title}</strong></div><SafeImage src={selected.image} alt={`${selected.title} from Hunterpedia`} /></figure>
