...
export const organizationState390Corrections = freeze({
  ...
  'organization:heil-ly': freeze([
    ...
    state({
      ...
      operationalState: 'Morena’s Contagion community continues escalating into increasingly public violence and hidden-route defense while Xi-Yu, Cha-R, police, military, and the Phantom Troupe converge on the family.',
      ...
      relatedEventIds: ['event:luini-troupe-confrontation'],
      sources: [392, 393, 394, 398],
    }),
  ]),
});
