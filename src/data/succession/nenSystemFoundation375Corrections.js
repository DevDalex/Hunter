...
export const guardianBeastState375Corrections = freeze({
  ...
  'guardian-beast:halkenburg': freeze([
    ...
    state({ beastId: 'guardian-beast:halkenburg', start: 375, end: 381, knowledge: 'Enhancer symbiotic fellowship system revealed', operationalState: 'Feather-marked people gathered around Halkenburg increase the group’s collective aura and potential, with more marked participants producing a stronger state.', knownAbilityIds: ['ability:halkenburg-guardian-marking'], unresolved: ['Mark selection rule', 'Removal rule', 'Maximum-output trigger', 'Relationship to blackout and memory-loss phenomena'], sources: [375] }),
  ]),
