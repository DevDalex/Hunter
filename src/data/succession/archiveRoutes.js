...
export const successionArchiveRoutes = Object.freeze([
  ...
  route('chapters', 'chapter-records', 'Chapters', 'Records', 'Canonical chapter dossiers', 'Every Chapter 340 through the current published research boundary placed inside its story phase, active lanes, events, causal links, state changes, unresolved threads, evidence, and reader bridge. Local page-media availability through the latest imported reader release is tracked separately.', 'active'),
