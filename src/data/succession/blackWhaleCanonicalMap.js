...
export const blackWhaleCanonicalHotspotMap = Object.freeze({
  ...
  bulkhead: bridge(`${shipId}:intertier-2-3:central-gate`, 'chapter-409-resolved', 'Chapter 409 resolves the relevant central gate as the security separation between Tiers 2 and 3.'),
  'heil-ly': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'chapter-409-resolved', 'Chapter 409 confirms the active Heil-Ly negotiation base lies in the inter-tier space between Tiers 2 and 3 and has five entrances.'),
...
export const blackWhaleCanonicalRoomMap = Object.freeze({
  ...
  'Tier 2–3 Bulkhead': bridge(`${shipId}:intertier-2-3:central-gate`, 'chapter-409-resolved'),
  'Heil-Ly Secret Hideout': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'chapter-409-resolved'),
  'Shower / Rooms A and B': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'aggregate'),
  'Processing & Disposal Rooms': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'aggregate'),
  'Morena’s Office & Communal Area': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'aggregate'),
  'Heil-Ly Laundry & Dormitory': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'aggregate'),
  'Heil-Ly Kitchen & Meeting Space': bridge(`${shipId}:intertier-2-3:heil-ly-hideout`, 'aggregate'),
