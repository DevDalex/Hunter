...
export const relationshipFoundation411Expansion = freeze([
  ...
  relationship({
    ...
    sourceEntityId: 'character:kacho-hui-guo-rou', targetEntityId: 'character:fugetsu-hui-guo-rou', subtype: 'postdeath-nen-protective-dependency', sentiment: 'allied',
  ...
  relationship({
    ...
    sourceEntityId: 'character:kurapika', targetEntityId: 'character:woble-hui-guo-rou', subtype: 'protective-strategy-contest-eligibility', sentiment: 'allied',
