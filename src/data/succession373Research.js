...
export const succession373TimelineEvents = freeze([
  ...
  event({ id: '373-vergei-calls-1014', title: 'Vergei contacts Room 1014 from Marayam’s actual occupied quarters', detail: 'Shimanu receives a call from Marayam’s personnel. Vergei introduces himself to Kurapika while Marayam and Sevanti are physically present with him, proving that their household continues to occupy an accessible operational state even though Hanzo’s projected exploration encounters an empty version of Room 1013.', tracks: ['vergei', 'kurapika', 'shimanu', 'marayam', 'sevanti', 'room-1013'], location: 'Black Whale · Tier 1 · Room 1013 / Room 1014 communication link' }),
...
export const succession373ChapterResearch = freeze([
  freeze({
    ...
    prelude: freeze([]),
    characters: freeze(['Camilla Hui Guo Rou', 'Musse', 'Benjamin Hui Guo Rou', 'Furykov', 'Wolfe', 'Balsamilco Might', 'Hanzo', 'Kurapika', 'Shimanu', 'Vergei', 'Marayam Hui Guo Rou', 'Sevanti Hui Guo Rou']),
    appearances: freeze(['Camilla Hui Guo Rou', 'Musse', 'Benjamin Hui Guo Rou', 'Furykov', 'Wolfe', 'Balsamilco Might', 'Hanzo', 'Kurapika', 'Shimanu', 'Vergei', 'Marayam Hui Guo Rou', 'Sevanti Hui Guo Rou']),
