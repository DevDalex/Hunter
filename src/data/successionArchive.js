...
export const personnelTransitions = [
  ...base.personnelTransitions,
  {
    ...
    state: 'Parallel Future ten-second forecast lead explicitly revealed / earlier Chapter 385–386 knowledge remains frozen',
    source: wiki('Chapter_387'),
  },
  {
    day: 'Day 8 · flashback',
    chapters: '387',
    ...
    state: 'Continuous future viewing and demonstrated forecast-versus-actual divergence established / maximum duration unresolved',
    source: wiki('Chapter_387'),
  },
  {
    day: 'Day 8 · flashback',
    chapters: '387',
    subject: 'Tserriednich / Theta / Melody',
    ...
    state: 'Chapter 385 apparent assassination mechanism retrospectively explained / Melody effect kept mechanically separate',
    source: wiki('Chapter_387'),
  },
  {
    day: 'Day 8 · flashback',
    chapters: '387',
    subject: 'Tserriednich',
    ...
    state: 'Core Parallel Future mechanics understood by Tserriednich / broader observer and maximum-duration rules unresolved',
    source: wiki('Chapter_387'),
  },
  {
    day: 'Day 9',
    ...
    state: 'Sub-second eye-cycle remains a training target / achievement not established at Chapter 387 boundary',
    source: wiki('Chapter_387'),
  },
