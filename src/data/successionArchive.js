...
export const personnelTransitions = [
  ...
  },
  {
    ...
    route: 'Room 1013 projected exploration → occupied/empty state split → spatial-defense theory',
    change: 'Hanzo encounters an empty Room 1013 state in Chapter 372. Chapter 373 proves Vergei, Marayam, and Sevanti occupy a functioning state capable of calling Room 1014. In Chapter 374 Hanzo still sees the room as empty while Kurapika proposes spatial displacement and suspects a defensive Guardian Spirit Beast mechanism; Vergei refuses an outside-room test.',
    state: 'Spatial anomaly strongly confirmed / transport and Guardian Spirit Beast mechanism remain hypotheses',
  ...
  },
  {
    ...
    route: 'Room 1011 → manifested tunnel → Room 1010',
    change: 'A Nen door resembling the twins’ childhood tunnel playset appears for Fugetsu and carries her directly to Kacho’s bed. Melody detects Kacho’s reaction and decides to explain Nen to her.',
    state: 'First observed direct twin-room translocation / full conditions unresolved',
    source: wiki('Chapter_374'),
  },
  {
    day: 'Day 2',
...
export const wobleCoreTimeline = [
  ...
  },
  {
    ...
    detail: 'Hanzo’s projected investigation encounters an empty Room 1013 state, while Vergei, Marayam, and Sevanti continue to occupy a functioning state that can call Room 1014. In Chapter 374 Kurapika proposes that Nen spatially displaced the occupied quarters and suspects a defensive effect from Marayam’s Guardian Spirit Beast, but Vergei refuses the proposed outside-room test.',
    people: 'Hanzo, Kurapika, Vergei, Marayam, Sevanti, Sakata, Babimyna',
    source: wiki('Chapter_374'),
  },
].sort((left, right) => String(left.chapters).localeCompare(String(right.chapters), undefined, { numeric: true }));
