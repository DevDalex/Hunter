...
export const successionTimelinePhases = freeze([
  ...
  freeze({
    ...
    summary: 'Special Martial Law compresses movement, military command, disease, post-mortem curses, direct royal violence, and Tserriednich’s expanding future-perception escape into the same operating condition. Chapter 419 turns the VVIP corridors into a perception battlefield; Chapter 420 collides that escape with Hisoka in the casino and ends with Tserriednich outside Tier 1 facing missing bridges, dense Royal Army deployment, and a new Zetsu decision point.',
    before: 'The contest advances through compartmentalized covert operations.',
    after: 'Benjamin’s emergency apparatus, Hisoka’s independent violence, and Tserriednich’s perception warfare now intersect directly across Tier 1 movement routes.',
    focusTracks: freeze(['benjamin', 'tserriednich', 'hisoka', 'justice']),
    spotlightTerms: freeze(['special martial law', 'hell fruit', 'shoots tserriednich', 'gypsy life', 'laplace', 'casino', 'hisoka', 'bridges']),
    media: freeze([
