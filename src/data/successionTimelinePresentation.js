...
export const successionTimelinePhases = freeze([
  ...
  freeze({
    ...
    summary: 'Special Martial Law compresses movement, military command, disease, post-mortem curses, direct royal violence, and Tserriednich’s expanding future-perception escape into the same operating condition. Chapter 419 turns the VVIP corridors into an active perception battlefield and carries Tserriednich to the Tier 1 casino.',
    before: 'The contest advances through compartmentalized covert operations.',
    after: 'Benjamin’s emergency apparatus and Tserriednich’s perception warfare now collide directly across Tier 1 movement routes.',
    focusTracks: freeze(['benjamin', 'tserriednich', 'justice']),
    spotlightTerms: freeze(['special martial law', 'hell fruit', 'shoots tserriednich', 'gypsy life', 'laplace', 'casino']),
    media: freeze([
