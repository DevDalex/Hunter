...
const billGrowth388Ability = freeze({
  ability: 'Bill’s Growth Ability', user: 'Bill', owner: 'Bill', type: 'Enhancement · target growth', category: 'Growth / accelerated development', chapters: '388', chapter: 388,
  ...
  target: 'A demonstrated seed target and recipients in the class awakening procedure; broader target eligibility is not established.', confidence: 'Direct effect and Nen type confirmed / broader mechanics unresolved.', source: source388,
});
export const successionAbilities = freeze([...base.successionAbilities, billGrowth388Ability]);
export const successionMysteries = freeze([...base.successionMysteries, ...succession388Mysteries]);
export const dossierSources = freeze({ ...base.dossierSources, chapter388: source388, sourcePolicy388: succession388SourcePolicy });
