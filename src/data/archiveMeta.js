...
export const ARCHIVE_REVIEW_DATE = 'July 28, 2026';
export const ARCHIVE_SOURCE = 'Hunterpedia / Fandom, VIZ publication records, and independent translation/review cross-checks';
...
export const coverageLabels = {
  chapters: `Publication identity, reader authorization, and maintained scene-level research extend through Chapter ${ARCHIVE_DETAILED_BOUNDARY}.`,
  ...
  succession: `Developing current-arc roster, reader availability, and maintained Chapter 414–415 research extend through Chapter ${ARCHIVE_BOUNDARY}; per-record currency exposes remaining uncertainty in assignments, relationships, Nen, locations, and source interpretation.`,
  timeline: `Thirty-nine sourced structural blocks cover the complete series, with ${SITE_STATS.voyageEvents} selected Succession voyage events; detailed maintained chronology currently reaches Chapter ${ARCHIVE_DETAILED_BOUNDARY} and does not claim to transcribe every source-page event.`,
...
export const archiveBoundaryLabel = `Reader authorized and detailed maintained research verified through Chapter ${ARCHIVE_DETAILED_BOUNDARY}`;
