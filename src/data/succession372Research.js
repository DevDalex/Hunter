...
export const succession372TimelineEvents = freeze([
  ...
  event({ id: '372-first-class-ends', title: 'Kurapika’s first Nen lesson ends at 12:30 p.m.', detail: 'The supplied Chapter 372 notes state both that the first training session ends at 12:30 p.m. and that it lasted two and a half hours. Chapter 369 placed the class at 9:00 a.m., so the archive preserves these source figures without inventing a reconciled start/restart time.', tracks: ['kurapika', 'nen-class', 'training'], location: 'Black Whale · Tier 1 · Room 1014', time: 'Voyage Day 2 · 12:30 p.m.', confidence: '12:30 end time and 2.5-hour duration are both supplied; their tension with Chapter 369’s 9:00 a.m. timing is preserved as a source discrepancy' }),
...
export const succession372NenClassResearch = freeze({
  ...
  suppliedFirstSessionDuration: '2.5 hours',
  timingDiscrepancy: 'Chapter 369 places the class at 9:00 a.m., while Chapter 372 states both a 12:30 p.m. end and a 2.5-hour duration. The archive preserves all supplied figures without inventing a reconciliation.',
...
export const succession372ChapterResearch = freeze([
  freeze({
    ...
    sourceTextNotes: freeze([
      ...
      'Timing discrepancy preserved: Chapter 369 places the first class at 9:00 a.m.; Chapter 372 states a 12:30 p.m. end and a 2.5-hour duration. No unsupplied restart time is invented.',
    ]),
