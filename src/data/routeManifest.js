...
// Batch 4 promotes the redesigned Chapter and Event intelligence commands into the rendered release gate.
// The complete Succession hierarchy remains validated separately by the archive shell audit.
export const successionReleaseRouteIds = Object.freeze(['story', 'chapters', 'events', 'timeline', 'characters', 'princes', 'queens', 'organizations', 'black-whale', 'nen', 'research']);
