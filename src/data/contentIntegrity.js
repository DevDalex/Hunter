...
import { guardianBeasts, princeDossiers, successionChapterResearch } from './successionDossier';
...
export const integrityChecks = [
  ...
  {
    id: 'succession-chapter-depth', label: 'Succession chapter depth', status: successionChapterResearch.length === 74 && successionChapterResearch.every((chapter, index) => chapter.number === 340 + index && chapter.focus && chapter.source) ? 'pass' : 'fail',
    detail: `${successionChapterResearch.length} locally summarized records cover Chapters 340–413 continuously.`,
  },
  {
